...
import PublistRed from '../imports/components/PublistRed/PublistRed.jsx';
 ...
 *  SignUp
 */
import SignUp from '../imports/containers/SignUp/SignUp.jsx';

FlowRouter.route('/signup', {
  action(params) {
    ReactLayout.render(PublistRed, {content: <SignUp step="1" />});
  }
});

FlowRouter.route('/signup/:step', {
  action(params) {
    ReactLayout.render(PublistRed, {content: <SignUp step={params.step} />});
  }
});
...
FlowRouter.route('/over', {
  name: 'about',
  action(params) {
    ReactLayout.render(App, {content: <About />});
  }
});
